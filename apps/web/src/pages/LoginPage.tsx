...
export default function LoginPage() {
  ...
  return (
    <div className="h-[100dvh] flex flex-col items-center justify-center px-4 py-2 sm:py-8 relative overflow-hidden bg-surface-950">
      ...
      {/* Content Container */}
      <div className="relative z-10 w-full max-w-md flex flex-col justify-center h-full max-h-[800px] animate-fade-in">
        
        {/* Branding Area */}
        <div className="text-center mb-4 sm:mb-6 mt-auto sm:mt-0">
          ...
          <p className="text-white/40 text-[10px] sm:text-xs font-semibold uppercase tracking-widest">
        ...
        {/* Social Media Row */}
        <div className="mt-4 sm:mt-8 flex items-center justify-center gap-3 sm:gap-4 animate-slide-up shrink-0" style={{ animationDelay: '0.1s' }}>
          {/* Facebook */}
          <a href="#" className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-white/5 hover:bg-brand-500/20 border border-white/10 hover:border-brand-500/30 flex items-center justify-center text-white/60 hover:text-white transition-all duration-300 shadow-md">
        ...
        {/* Footer */}
        <p className="text-center text-white/20 text-[10px] sm:text-xs mt-4 sm:mt-8 mb-2 mt-auto">
